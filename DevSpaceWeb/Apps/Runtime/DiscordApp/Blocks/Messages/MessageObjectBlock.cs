...
public class MessageObjectBlock : DiscordBlock
{
    ...
    {
        if (Block.inputs.TryGetValue("content", out WorkspaceBlockConnection? content) && content.block != null)
    ...
    {
        if (Block.inputs.TryGetValue("obj_embed", out WorkspaceBlockConnection? embed) && embed.block != null)
