...
public class ChannelObjectBlock : DiscordBlock
{
    ...
    {
        if (Block.inputs.TryGetValue("category", out RequestBlocksBlock block) && block.block != null)
    ...
    {
        if (Block.inputs.TryGetValue("topic", out RequestBlocksBlock block) && block.block != null)
            return await Runtime.GetStringFromBlock(block.block);
    ...
    {
        if (Block.inputs.TryGetValue("slowmode", out RequestBlocksBlock block) && block.block != null)
    ...
    {
        if (Block.inputs.TryGetValue("is_nsfw", out RequestBlocksBlock block) && block.block != null)
