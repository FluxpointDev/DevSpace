...
public static class GridWidth
{
    public static string Id = "200px";
    public static string Name = "200px";
    public static string NameWithIcon = "220px";
    ...
    public static string ActionButton = "130px";
    public static string Domain = "140px";
    public static string IP = "120px";
}
