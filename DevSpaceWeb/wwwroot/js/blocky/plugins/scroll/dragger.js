...
export class EdgeScrollOptions {
...
export class ScrollBlockDragger extends Blockly.dragging.Dragger {
    ...
    scrollDelta_ = new Blockly.utils.Coordinate(0, 0);

    /** How much the block has been moved due to dragging. */

    dragDelta_ = new Blockly.utils.Coordinate(0, 0);
    ...
    scrollDirections_ = ['top', 'bottom', 'left', 'right',];
    ...
    moveBlockWhileDragging(deltaX, deltaY) {
        if (!this.draggable.getBoundingRectangle)
            return;
